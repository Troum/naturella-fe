    ...
    b-row.w-100.mx-auto.my-5
        b-col.mx-auto.p-0.my-5( cols="10" )
            b-card#info.border-0.shadow-sm.bg-light
                            ...
                            b-form#results-form.w-75( @submit.prevent="passes(submit)" )
                                validation-provider( rules="required" name="Дата розыгрыша" v-slot="{ errors }")
                                    ...
                                    b-form-group.ml-4.my-3
                                        b-button( type="submit" variant="warning" ) Добавить
                    b-col.shadow.rounded-sm.bg-warning.text-dark.p-3( cols="6" )
                        h6 Инструкция
                        ol
                ...
                div.text-center
                    b-button.mx-auto.w-25( type="button" variant="warning" @click="showResults") Показать результаты
                        ...
                        b-col.m-0.p-0( cols="12" )
                            b-input-group
                                ...
                                b-input-group-append
                                    b-button.rounded-0.w-100( @click="filterItems" type="button" size="md" variant="warning" )
                                        small Найти
