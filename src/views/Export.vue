        ...
        b-col.mx-auto.p-0.my-5( cols="10" )
            b-row.m-0.p-0
                        ...
                        validation-observer( ref="observer" v-slot="{ passes }" )
                            b-form#export-form( @submit.prevent="passes(submit)" )
                                ...
                                b-form-group.ml-4.my-3.text-center
                                    b-button( type="submit" variant="warning" ) Сформировать
                b-col.text-center.mx-auto( cols="10" xl="6" )
                    ...
                    transition( enter-active-class="animated fadeIn" leave-active-class="animated fadeOut" mode="out-in" )
                        b-button( variant="warning" @click="download = false" :href="`${url}/v1/auth/download`" type="button" v-if="download" ) Выгрузить
</template>
