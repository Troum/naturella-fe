                ...
                b-form#participant.mx-auto.w-100( @submit.prevent="passes(submit)" :class="[!needCheck ? 'check' : '']" )
                    b-row.m-0
                        ...
                        b-col.mx-auto.my-xl-3( xl="10"  )
                            p.text-center.mt-0.d-flex.align-items.center.justify-content-center(v-if="needCheck" style="color: #fff" )
                                toggle-button( :value="accept.one" v-model="accept.one"
                                    :color={checked: '#f07e17', unchecked: '#dedede'}
                            ...
                            p.text-center.mt-0.d-flex.align-items.center.justify-content-center(v-if="needCheck" style="color: #fff" )
                                toggle-button( :value="accept.two" v-model="accept.two"
                                    :color={checked: '#f07e17', unchecked: '#dedede'}
                                    :labels="{checked: 'Да', unchecked: 'Нет'}")
                            ...
                            b-form-group.my-4.my-xl-2.my-xl-4.text-center
                                b-button.register.text-uppercase( v-if="needCheck" type="submit" size="lg"  :disabled="!accept.one || !accept.two" )
                                    small.font-weight-bold Зарегистрироваться
                                b-button.register.text-uppercase( v-else type="submit" size="lg" )
                                    small.font-weight-bold Зарегистрироваться
